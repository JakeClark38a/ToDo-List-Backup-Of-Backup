...
function teamlist(id, name, des) {
    if (user.user_id == team[id].admin) {
      ...
      <div id="div_button `+ id +`" class="inline-block justify-self-end self-center mr-4">
                        <button id="dropdownMenuIconButton `+ id + `" data-dropdown-trigger="click"  data-dropdown-toggle="dropdownDots `+ id +`" class="dropdown_button inline-flex items-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-600" type="button">
                            ...
                            <!-- Dropdown menu -->
                            <div id="dropdownDots `+ id +`" class="dropdown z-10 hidden border-2 border-white bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
