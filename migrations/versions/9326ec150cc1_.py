...
Revision ID: 9326ec150cc1
Revises: cff3d18ec42e
Create Date: 2024-05-08 17:54:45.636390
...
revision = '9326ec150cc1'
down_revision = 'cff3d18ec42e'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.create_foreign_key('users_ibfk_1', 'teams', ['last_join_team'], ['team_id'])
        batch_op.alter_column('last_join_team',
