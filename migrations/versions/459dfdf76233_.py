...
Revision ID: 459dfdf76233
Revises: 8914215a0696
Create Date: 2024-05-06 18:16:35.004739
...
revision = '459dfdf76233'
down_revision = '8914215a0696'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    with op.batch_alter_table('trees', schema=None) as batch_op:
        batch_op.add_column(sa.Column('lastAction', mysql.VARCHAR(charset='utf8mb3', collation='utf8mb3_general_ci', length=40), nullable=True))
        batch_op.alter_column('user_id',
               existing_type=sa.NVARCHAR(length=40),
               type_=mysql.VARCHAR(charset='utf8mb3', collation='utf8mb3_general_ci', length=40),
               existing_nullable=False)
