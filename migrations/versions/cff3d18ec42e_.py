...
Revision ID: cff3d18ec42e
Revises: c1b89de0b388
Create Date: 2024-05-07 14:37:30.165545
...
revision = 'cff3d18ec42e'
down_revision = 'c1b89de0b388'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('teamtags', schema=None) as batch_op:
        ...
        batch_op.alter_column('team_id',
               ...
               type_=sa.NVARCHAR(length=40),
               existing_nullable=False)
        batch_op.drop_constraint('teamtags_ibfk_2', type_='foreignkey')
        batch_op.create_foreign_key(None, 'teamgroupss', ['group_id'], ['group_id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('teamtasks', schema=None) as batch_op:
        ...
        batch_op.alter_column('completed_user',
               ...
               type_=sa.NVARCHAR(length=40),
               existing_nullable=True)
        batch_op.drop_constraint('teamtasks_ibfk_3', type_='foreignkey')
        batch_op.create_foreign_key(None, 'teamtags', ['tag_id'], ['tag_id'], ondelete='CASCADE')
...
def downgrade():
    ...
    with op.batch_alter_table('teamtasks', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('teamtasks_ibfk_3', 'tags', ['tag_id'], ['tag_id'], ondelete='CASCADE')
        batch_op.alter_column('completed_user',
               existing_type=sa.NVARCHAR(length=40),
               type_=mysql.VARCHAR(charset='utf8mb3', collation='utf8mb3_general_ci', length=40),
               existing_nullable=True)
    ...
    with op.batch_alter_table('teamtags', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key('teamtags_ibfk_2', 'groupss', ['group_id'], ['group_id'], ondelete='CASCADE')
        batch_op.alter_column('team_id',
               existing_type=sa.NVARCHAR(length=40),
               type_=mysql.VARCHAR(charset='utf8mb3', collation='utf8mb3_general_ci', length=40),
               existing_nullable=False)
