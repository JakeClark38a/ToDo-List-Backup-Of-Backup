...
Revision ID: 8a26199f2ac8
Revises: 
Create Date: 2024-05-02 08:42:06.876546
...
def upgrade():
    ...
    with op.batch_alter_table('groupss', schema=None) as batch_op:
        batch_op.add_column(sa.Column('def_tag', sa.NVARCHAR(length=40), nullable=True))
