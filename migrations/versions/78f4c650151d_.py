...
Revision ID: 78f4c650151d
Revises: 
Create Date: 2024-04-30 20:32:31.931141
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('country', sa.NVARCHAR(length=200), nullable=True))
        batch_op.alter_column('user_id',
               existing_type=mysql.VARCHAR(charset='utf8mb3', collation='utf8mb3_general_ci', length=40),
               type_=sa.NVARCHAR(length=40),
               existing_nullable=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('location', mysql.VARCHAR(charset='utf8mb3', collation='utf8mb3_general_ci', length=200), server_default=sa.text("''"), nullable=True))
        batch_op.alter_column('external_id',
